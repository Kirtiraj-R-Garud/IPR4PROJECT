         ...
         <!-- FIRST BLOCK -->
		  <div id="about-us">
            ...
            <article class="s-12 m-12 l-6">
               <h2 style="font-size:42px">Trademark</h2>
               <p style="font-size:20px">A trademark is a sign capable of distinguishing the goods or services of one enterprise from those of other enterprises. <br><br> Trademarks date back to ancient times when craftsmen used to put their signature or "mark" on their products.
               </p>
            </article>
         </div>
		 <!---Our works-->
