...
How many companies in India are IP driven,  do we see this info coming in quarterly result, how many reporters raise questions about the IP issue during interviews and talk show.
People talk about strategic direction (IoT, Digital etc), which is indirectly related to IP, however few talks clearly in terms of  IP (Patent Goals, Area of interest, IP driven Collaborations etc)
Predominantly, Indian companies are service driven and IP is dominated by product driven companies, is this one of the reason.
</p>
...
Is IP a hype  , but then when merger or acquisition happens, it is the prime asset and add valuation in the range of 30 to 60% to overall company asset valuation.<br>

Indian patent offices are publishing the patent application list, where more than 80% inventions  application are from non indian companies.<br>
How long and when we will become IP driven ?<br>
Do we need to change work culture ?
				 ...
				 <h3><b><u>IPR, Innovation and Students:</u></b></h3>
				  ...
				  <h3><b><u>Patents: Making it simple and reducing the fear</u></b> </h3>
				   <p style="font-size:20px;color:#606060;LINE-HEIGHT:25px;">Main roadblock in building the IP asset is fear about the patent filling process and investment needed. Mr.Dnyaneshwar Kamble ,  Technology evangelist and visionary young leader, board member of IEEE Bombay section and advisor to various technical institutes , conceptualized  and formed the core team with Mr.Pratik Baheti (BE Student), to facilitate following actions:</p>
				   <ul>
  ...
  <li style="font-size:20px;color:#606060;LINE-HEIGHT:30px;">Guidance of mentors :  Dr.Saurabh Mehta (VIT), Prof. Kiran Talele (SPIT), Dr.Vinit Dongre (TCET), Mr.Abhay Phansikar (Startup Consultant and Vice President IEEE Bombay section) and Dr. Dinesh Israni (Counsultant at SP-TBI) to advice students through Ipr4students . Based on their availability, they will conduct the IPR sessions.</li>
...
<p style="font-size:20px;color:#606060;LINE-HEIGHT:30px;">Pratik Baheti is highly motivated and committed student for national cause. He has filed three patent applications.<br>Mr.Shubham Madke, Mr.Shubham Patil and Mr. Kirtiraj R. Garud are volunteering for building the website. </p>
            </div>
         </div>         
         <!-- SERVICES -->
         <div id="services">
      ...
      <footer>
         <div class="line">
            <div class="s-12 l-6">
               ...
               <a href="https://www.twitter.com/ipr4students "><img src="img/socialicon1.png" href="https://www.facebook.com/ipr4students "><img src="img/socialicon2.png"></a>
               <p>For Query contact support@ipr4student.org</p>
               <p>Designed and Maintained by : <a href="mediaspa.in"><font size="2" color="white"><strong>Mediaspa<strong></font></a>&
               <a href="rainbowdimensions.com"><font size="2" color="white"><strong>Rainbow Dimensions<strong></font></a></p>
